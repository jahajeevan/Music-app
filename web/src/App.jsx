      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflow: 'hidden', position: 'relative' }}>
          <div style={{
            ...
            display: activeTab === 'home' ? 'flex' : 'none', flexDirection: 'column',
          }}>
            <HomeScreen {...screenProps} />
          </div>
          <div style={{
            position: 'absolute', inset: 0,
            display: activeTab === 'search' ? 'flex' : 'none', flexDirection: 'column',
          }}>
            <SearchScreen {...screenProps} />
          </div>
          <div style={{
            position: 'absolute', inset: 0,
            display: activeTab === 'discover' ? 'flex' : 'none', flexDirection: 'column',
          }}>
            <DiscoverScreen {...screenProps} />
          </div>
          <div style={{
            position: 'absolute', inset: 0,
            display: activeTab === 'library' ? 'flex' : 'none', flexDirection: 'column',
          }}>
            <LibraryScreen {...screenProps} />
          </div>
          <div style={{
            position: 'absolute', inset: 0,
            display: activeTab === 'social' ? 'flex' : 'none', flexDirection: 'column',
          }}>
